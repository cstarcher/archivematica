...
We accept bugs submitted through Github Issues or through our [technical](https://groups.google.com/forum/#!forum/archivematica-tech) or [user](https://groups.google.com/forum/#!forum/archivematica) mailing lists.
...
Small contributions such as fixing spelling errors, where the content is small enough to not be considered intellectual property, do not require signing a CLA.
...
These contributions are still valuable!
They are also a great way to figure out the contribution process without having to worry about making a large change.
...
The Archivematica development team uses [Sublime Text](sublimetext.com/) with the [SublimeLinter-flake8](https://github.com/SublimeLinter/SublimeLinter-flake8) plugin, which automatically scans your code and displays any style notes inline.
