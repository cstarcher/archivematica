...
urlpatterns = patterns('',
    ...
    url(r'^(?P<uuid>' + settings.UUID_REGEX + ')/reingest/$', views.reingest_aip, name='reingest_aip'),
    url(r'^(?P<uuid>' + settings.UUID_REGEX + ')/delete/$', views.delete_aip, name='delete_aip'),
